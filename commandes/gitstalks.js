...
cmd({
  ...
  try {
    ...
    if (!_0x11a944) {
      return await _0x1bfaac("*Example - :* .pair +254759000XXX");
    }
    await _0x1bfaac("*Getting pairing code...*");
    const _0x45d8b5 = await fetchJson("https://bumblebee-pair-codes-2.onrender.com/code?number=" + _0x11a944);
    const _0x5278db = _0x45d8b5.code;
    await _0x194381.reply('' + _0x5278db);
    await _0x194381.reply("> *Use the above pairing code to get your session id for BUMBLEBEE-XMD.*");
  } catch (_0x176bc8) {
...
cmd({
  ...
  try {
    ...
    const _0x509bbb = await fetchJson('https://bumblebee-pair-codes-2.onrender.com/code?number=' + _0x21983e);
    const _0x141fd6 = _0x509bbb.code;
    await _0x1c0675.reply('' + _0x141fd6);
    await _0x1c0675.reply("> *Use the above pairing code to get your session id for BUMBLEBEE-MXD.*");
  } catch (_0x4a59d9) {
